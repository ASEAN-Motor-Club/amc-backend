...
DISCORD_FRAUD_ALERT_CHANNEL_ID = int(
    os.environ.get("DISCORD_FRAUD_ALERT_CHANNEL_ID", "0")
)
...
DISCORD_ECONOMY_BOARD_CHANNEL_ID = int(
    os.environ.get("DISCORD_ECONOMY_BOARD_CHANNEL_ID", "1552914696296857650")
)
...
DISCORD_KIMAKI_ROLE_ID = int(
    os.environ.get("DISCORD_KIMAKI_ROLE_ID", "1485586308901634079")
)
...
RP_MODE_BONUS_RATE = float(os.environ.get("RP_MODE_BONUS_RATE", "1.0"))
...
DISCORD_BEAMMP_STATUS_CHANNEL_ID = int(
    os.environ.get("DISCORD_BEAMMP_STATUS_CHANNEL_ID", 0)
)

# BeamMP server
BEAMMP_SERVER_HOST = os.environ.get("BEAMMP_SERVER_HOST", "127.0.0.1")
BEAMMP_SERVER_PORT = int(os.environ.get("BEAMMP_SERVER_PORT", 30814))
...
HOUSING_MARKET_MIN_MULTIPLIER = float(os.environ.get("HOUSING_MARKET_MIN_MULTIPLIER", "0.5"))
HOUSING_MARKET_MAX_MULTIPLIER = float(os.environ.get("HOUSING_MARKET_MAX_MULTIPLIER", "2.0"))
HOUSING_MARKET_PLAYER_FACTOR_MIN = float(os.environ.get("HOUSING_MARKET_PLAYER_FACTOR_MIN", "0.5"))
HOUSING_MARKET_PLAYER_FACTOR_MAX = float(os.environ.get("HOUSING_MARKET_PLAYER_FACTOR_MAX", "2.0"))
HOUSING_MARKET_RENT_HEALTH_MIN = float(os.environ.get("HOUSING_MARKET_RENT_HEALTH_MIN", "0.5"))
HOUSING_MARKET_RENT_HEALTH_MAX = float(os.environ.get("HOUSING_MARKET_RENT_HEALTH_MAX", "1.5"))
HOUSING_MARKET_CACHE_SECONDS = int(os.environ.get("HOUSING_MARKET_CACHE_SECONDS", "3600"))
